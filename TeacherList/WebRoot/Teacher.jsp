    ...
    <head>
        ...
        <script language="javascript">
            ...
            function openSearch(){
                ...
                window.location.href = 'Teacher.jsp?name='+keyWord;
            }
                ...
                <table width="888" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="wlink">
                          <tr>
                            <td> <a href="TeacherAdd.jsp">添加教师信息</a> | <a href="PasswordModify.jsp">修改密码</a> | <a href="AdminQuit.jsp">退出</a></td>
                          </tr>
                          </table>
                      </td>
                    </tr>
...
<%
		...
		String sql;
		if(name==null)
			sql="select T.dept_name,S.dept_name,teacher.teacher_id,teacher.teacher_name,teacher.teacher_title,teacher.teacher_tel,teacher.teacher_address,teacher.teacher_email from department as S,department as T,teacher where S.dept_id=teacher_dept_id and T.dept_id=S.father_id";
		else
			sql="select T.dept_name,S.dept_name,teacher.teacher_id,teacher.teacher_name,teacher.teacher_title,teacher.teacher_tel,teacher.teacher_address,teacher.teacher_email from department as S,department as T,teacher where S.dept_id=teacher_dept_id and T.dept_id=S.father_id and teacher_name like '%" + name + "%'";		
		if(con!=null){
			dm.executeUpdate("delete from teacher where teacher_id='" + request.getParameter("delete_id") + "'");
		...
		try{
			if(rs!=null&&rs.next()){
				...
				while(rs.next()){
					...
					out.println("<td>");
					out.println("<a href="+"TeacherModify.jsp?teacher_id="+rs.getInt("teacher_id")+"><img height=\"16\" align=\"absmiddle\" src=\"images/pensil.png\"/></a>");					
					out.println("<a href="+"Teacher.jsp?delete_id="+rs.getInt("teacher_id")+" onclick=\"return confirm('确定删除吗?');\"><img height=\"16\" align=\"absmiddle\" src=\"images/trash.png\"/></a>");					
					out.println("</td>");					
					out.println("</tr>");
				}
			}
